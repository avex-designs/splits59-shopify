...
(function() {
  ...
  if ('rivets' in window) {
    ...
    // NOTE: Custom formatter for splits59. Remove color name from product title. Expected format: My Product - My product color
    rivets.formatters.removeColorOption = function(a){
      return a.split(" - ")[0];
    };
